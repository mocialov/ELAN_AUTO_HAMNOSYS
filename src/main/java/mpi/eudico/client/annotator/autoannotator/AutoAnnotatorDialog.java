package mpi.eudico.client.annotator.autoannotator;
 ...
 * @author aarsom
 */
public class AutoAnnotatorDialog {
     ...
     */
    public AutoAnnotatorDialog(Frame frame){
        this(frame, false);
    }
     ...
     */
    public AutoAnnotatorDialog(Frame frame, boolean autoUpdate){
        parent = frame;
